...
public class Robot extends TimedRobot {
	...
	public void disabledPeriodic() {
		...
		SmartDashboard.putString("DS Message: ", DriverStation.getGameSpecificMessage());
	}
	...
	public void autonomousInit() {
		...
		autonomousCommand = new Autonomous_AMESPaths();//AutonomousTestGroup(DriverStation.getGameSpecificMessage());
